...
class Model(dict, metaclass=ModelMetaclass):
    ...
    async def save(self):
        ...
        args.append(self.getValueOrDefault(self.__primary__key__))
...
class IntegerField(Field):
    def __init__(self, name=None, primary_key=False, default=None, column_type='int' ):
        super().__init__(name, column_type, primary_key, default)
